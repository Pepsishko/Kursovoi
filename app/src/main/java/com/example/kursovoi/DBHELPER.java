...
public class DBHELPER extends SQLiteOpenHelper {
   ...
   public ArrayList<String> genre;
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + MAIN_TABLE + " (ID_MAIN INTEGER PRIMARY KEY AUTOINCREMENT, NAME_OF_BOOK TEXT,GENRE INTEGER,AUTHOR INTEGER,CITY INTEGER,PUBLISHER INTEGER,YEAR INTEGER,PAGES INTEGER,ISBN TEXT," +
